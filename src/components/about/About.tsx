      ...
      <div className="container about__container">
        <div className="about__content">
          ...
          <p>
            ...
            detail critical decisions, and keeping up with an intense workflow.
            Familiar with manifesting abstract ideas and goals into tangible
            solutions and designs. Passionate about starting a new career in
            tech. Being able to design and develop high end user interfaces as
            well as exercise my problem-solving skills is my ideal career.
          </p>
